...
namespace NetCoreClient1.Pages
{
    public class IndexModel : PageModel
    {
        ...
        [BindProperty]
        public string Sender { get; set; } = "Fish";
        [BindProperty]
        ...
        private string MOCK_USERID { get; set; } = "ID_12345";
        ...
        public async Task InitializeConnection()
        {
            ...
            connection.On<MessageToGroup>("GroupReceiveMessage", (MessageToGroup) =>
            {
                ...
                Debug.WriteLine("[Client 1] " + newGroupMessage);
            });
            ...
            connection.On<Message>("ReceiveMessage", (message) =>
            {
                ...
                Debug.WriteLine("[Client 1] " + newMessage);
            });
